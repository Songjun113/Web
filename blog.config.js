...
const BLOG = {
  ...
  SINCE: process.env.NEXT_PUBLIC_SINCE || '', // 留空时使用当前年份
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '生物医学工程，脑机接口与智能康复研究', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://songjundu.com', // 网站地址
  KEYWORDS:
    process.env.NEXT_PUBLIC_KEYWORD ||
    '生物医学工程, 脑机接口, 康复工程, EEG, BCI, 人工智能', // 网站关键词 英文逗号隔开
