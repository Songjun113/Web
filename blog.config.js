...
const BLOG = {
  ...
  GREETING_WORDS:
    process.env.NEXT_PUBLIC_GREETING_WORDS ||  '人生之路，路凇沆砀，因缘际会，奇伟共赏',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '松菌君', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '生物医学工程专业就读，初窥门径', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://songjundu.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'dsjzzn@buaa.edu.cn', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/Songjun113', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '7620956697', // 对应歌单的 id
  ...
  COMMENT_CUSDIS_APP_ID: process.env.NEXT_PUBLIC_COMMENT_CUSDIS_APP_ID || '4e8cd54a-3808-4069-8ed1-1e7481b144cf', // data-app-id 36位 see https://cusdis.com/
  COMMENT_CUSDIS_HOST:
